...
<div class="container page-404">
	<div class="error-404">
		...
		<p class="go-back-home"><a href="<?php echo esc_url( home_url('/') ); ?>"><i class="far fa-chevron-left"></i><?php echo penci_get_setting( 'penci_trans_back_to_homepage' ); ?></a></p>
		<?php endif; ?>
	</div>
</div>
<?php get_footer(); ?>