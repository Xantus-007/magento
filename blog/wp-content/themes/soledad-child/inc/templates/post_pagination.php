		...
		<div class="prev-post">
			...
			<div class="prev-post-inner">
				...
				<a href="<?php echo esc_url( get_the_permalink( $prev_post->ID ) ); ?>">
					<div class="pagi-text">
						<h4 class="prev-title"><?php echo sanitize_text_field( get_the_title( $prev_post->ID ) ); ?></h4>
					</div>
				</a>
			</div>
		</div>
		...
		<div class="next-post">
			...
			<div class="next-post-inner">
				...
				<a href="<?php echo esc_url( get_the_permalink( $next_post->ID ) ); ?>">
					<div class="pagi-text">
						<h4 class="next-title"><?php echo sanitize_text_field( get_the_title( $next_post->ID ) ); ?></h4>
					</div>
				</a>
			</div>
		</div>
