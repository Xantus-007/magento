				...
				<div class="theiaStickySidebar">
					<div class="archive-box">
						<div class="title-bar">
							...
							echo penci_get_setting( 'penci_trans_author' );
							echo ' </span>';
							printf( wp_kses ( __( '<h1 class="page-title">%s %s</h1>', 'soledad' ), penci_allow_html() ), get_userdata( get_query_var('author') )->first_name, get_userdata( get_query_var('author') )->last_name );
							?>
						</div>
					</div>

					<?php 
					$ID = get_userdata(get_query_var('author') )->id;
					set_query_var( 'ID', $ID );
