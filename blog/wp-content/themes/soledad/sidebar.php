...
<div id="sidebar" class="penci-sidebar-content <?php echo sanitize_text_field( $heading_title . ' ' . $heading_align ); ?><?php if ( get_theme_mod( 'penci_sidebar_sticky' ) && !is_home() && !is_front_page() ): echo ' penci-sticky-sidebar'; endif; ?>">
