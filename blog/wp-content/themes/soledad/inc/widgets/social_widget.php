	...
	class penci_social_widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			<div class="widget-social<?php if( $align ): echo ' '. $align; endif; ?><?php if( $text ): echo ' show-text'; endif; ?><?php if( $circle ): echo ' remove-circle'; endif; ?><?php if( $size_upper ): echo ' remove-uppercase-text'; endif; ?><?php if( $border_radius ): echo ' remove-border-radius'; endif; ?><?php if( $brand_color && ! $circle ){ echo ' penci-social-colored'; } elseif( $brand_color && $circle ){ echo ' penci-social-textcolored'; } ?>">
				...
				<?php if ( $line ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_line' ) ); ?>" rel="nofollow" target="_blank"><i class="penci-icon-line" <?php echo $style_icon_svg; ?>><?php echo penci_svg_social( 'line', $size_icon ); ?></i><span <?php echo $style_text; ?>><?php esc_html_e( 'LINE', 'soledad' ); ?></span></a>
				<?php endif; ?>
				
				<?php if ( $viber ) : ?>
					<a href="<?php echo esc_attr( get_theme_mod( 'penci_viber' ) ); ?>" rel="nofollow" target="_blank"><i class="penci-icon-viber" <?php echo $style_icon_svg; ?>><?php echo penci_svg_social( 'viber', $size_icon ); ?></i><span <?php echo $style_text; ?>><?php esc_html_e( 'Viber', 'soledad' ); ?></span></a>
				<?php endif; ?>
