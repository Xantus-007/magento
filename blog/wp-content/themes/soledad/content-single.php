		...
		<?php if ( ! get_theme_mod( 'penci_single_meta_author' ) || ! get_theme_mod( 'penci_single_meta_date' ) || ! get_theme_mod( 'penci_single_meta_comment' ) || get_theme_mod( 'penci_single_show_cview' ) ) : ?>
			<div class="post-box-meta-single">
				<?php if ( ! get_theme_mod( 'penci_single_meta_author' ) ) : ?>
					<span class="author-post byline"><span class="author vcard"><?php echo penci_get_setting( 'penci_trans_written_by' ); ?> <a class="author-url url fn n" href="<?php echo get_author_posts_url(get_the_author_meta( 'ID' )); ?>" ><?php echo get_the_author_meta( 'last_name' ).' '.get_the_author_meta( 'first_name' ); ?></a> </span></span>
				<?php endif; ?>
		...
		<div class="inner-post-entry entry-content" id="penci-post-entry-inner">
			...
			?>
					<div class="produitmonbento">
						<h3 class="penci-recipe-title">Produits présentés</h3>
						<div class="productspres">
							<?php 
								while ( have_rows('produits') ) : the_row();
							?>
									<div class="productpres">
										<img src="<?php the_sub_field('image_produit'); ?>" alt="productimage" />
										<span class="titleprod"><?php the_sub_field('titre_produit'); ?></span>
										<span class="subtitleprod"><?php the_sub_field('sous_titre_produit'); ?></span>
										<a class="productlink" href="<?php the_sub_field('url_produit'); ?>"><?php _e('Acheter', 'monbento'); ?></a>
