...
class WP_Mailjet_Subscribe_Widget extends WP_Widget
{
    ...
    {
        $prefix_html_message_ok = '<div class="o-alert--success"><div class="o-table"><div class="o-table__cell--valignMiddle"><span class="c-fonticon__icon--success"></span><span class="c-msg">';
        $suffix_html_message_ok = '<a href="" class="c-close"><span class="c-fonticon__icon--close"></span></a></div>';
        $prefix_html_message_nok = '<div class="o-alert--error"><div class="o-table"><div class="o-table__cell--valignMiddle"><span class="c-fonticon__icon--error"></span><span class="c-msg">';
        $suffix_html_message_nok = '<a href="" class="c-close"><span class="c-fonticon__icon--close"></span></a></div>';
        ...
        if (!$this->validate_email($_POST['email'])) {
            print $prefix_html_message_nok;
            print _e('Format d\'e-mail invalide.', 'wp-mailjet-subscription-widget');
            print $suffix_html_message_nok;
            die;
        }
        ...
        print $prefix_html_message_ok;
        echo '<p class="success">' . __('E-mail de confirmation d\'abonnement envoyé.', 'wp-mailjet-subscription-widget') . '</p>';
        print $suffix_html_message_ok;
        die;
    }
    ...
    function widget($args, $instance)
    {
        ...
        <div class="c-newsletter">
          <div class="c-newsletter__title"><?php print _e("Tenez vous informés en vous inscrivant à notre newsletter"); ?></div>
          <div class="c-newsletter__form">
            <form class="subscribe-form">
                <?php if ($this->_userVersion === 3): ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
                <input id="email" name="email" type="text" placeholder="<?php print _e("Adresse e-mail"); ?>" required />
                <input name="list_id" type="hidden" value="<?php echo $list_id; ?>"/>
                <input name="action" type="hidden" value="mailjet_subscribe_ajax_hook"/>
                <input name="submit" type="submit" class="mailjet-subscribe" value="<?php print $button_text ?>">
            </form>
          </div>
