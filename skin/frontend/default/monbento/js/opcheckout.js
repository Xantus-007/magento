...
Checkout.prototype = {
    ...
    reloadProgressBlock: function(){
        var button = $$('.btn-checkout');
        if(button) {
            button[0].writeAttribute('disabled');
            button[0].setOpacity(0.5);
            $('order-please-wait').setStyle('display:block;');
        }
        ...
        var updater = new Ajax.Updater(
                ...
                this.progressUrl, 
                {
                    ...
                    onComplete: function() {
                        if(button) {
                            button[0].writeAttribute('disabled', false);
                            button[0].setOpacity(1);
                            $('order-please-wait').setStyle('display:none;');
                        }
                    }
                }
            );
