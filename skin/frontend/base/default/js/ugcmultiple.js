...
var ugcMultiple = function (config) {
    ...
    var recipientLinkContainer = $('ugc-form-link-add-recipient');
...
//        MyTabs.removeTabTitles('h5.tab-title');
        ...
        recipientLinkContainer.insert({bottom:'<div class="clearer"></div><a href="#" id="add-recipient" title="' + addTitle + '">'  + addTitle + '</a>'});
