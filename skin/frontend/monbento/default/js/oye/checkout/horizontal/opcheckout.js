...
//        var section = $(Event.element(event).up().up());
    ...
    updateCoupon: function (reqid) {
        ...
        var jqxhr = jQuery.post( couponUrl, {coupon_code:jQuery('#coupon_code').val()},function(data) {
    ...
    gotoSection: function (section, reloadProgressBlock) {
        ...
        var stepSectionElement = $('step-opc-' + section);
        stepSectionElement.addClassName('allow');
        console.log(stepSectionElement);
    ...
    setMethod: function(){
        if ($('login:guest') && $('login:guest').checked) {
            ...
            var formKey = $$('input[name="form_key"]')[0].value;
            var request = new Ajax.Request(
                this.saveMethodUrl,
...
Billing.prototype = {
    ...
    newAddress: function(isNew){
        if (isNew) {
            ...
            Element.hide('billing-current-address');
        } else {
            Element.hide('billing-new-address-form');
            var selectElement = $('billing-address-select');
            $('billing-current-address').innerHTML = selectElement.options[selectElement.selectedIndex].innerHTML;
            Element.show('billing-current-address');
        }
    },
...
Shipping.prototype = {
    ...
    newAddress: function(isNew){
        if (isNew) {
            ...
            Element.hide('shipping-current-address');
        } else {
            Element.hide('shipping-new-address-form');
            var selectElement = $('shipping-address-select');
            $('shipping-current-address').innerHTML = selectElement.options[selectElement.selectedIndex].innerHTML;
            Element.show('shipping-current-address');
        }
...
Review.prototype = {
    ...
    save: function(){
        ...
        if ($('billing:fiscal_id')) {
            params += '&fiscalId='+$('billing:fiscal_id').value;
        }
        params.save = true;
        var request = new Ajax.Request(
            this.saveUrl,
