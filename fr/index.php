...
$isDbm = ($_SERVER['REMOTE_ADDR'] == '193.251.87.9' || $_SERVER['REMOTE_ADDR'] == '::1');
...
switch($_SERVER['HTTP_HOST']) {
    ...
    case "monbento.de":
        $version = "de";
        break;
    case "us.monbento-temp.dbm-agence.com":
    case "us.monbento.com":
        $version = "us_en";;
        break;
    case "hk.monbento-temp.dbm-agence.com":
