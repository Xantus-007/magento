...
$config = $locale == 'fr_FR' ? $config_fr : $config_uk ;

$url = BASE . 'lot.php?id_lot=' . $lot->id_lot ;
if($fid) $url .= '&fid=' . $fid ;
?>
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="fr-FR" xmlns:fb="https://www.facebook.com/2008/fbml"> 
 <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object#">
  ...
  <meta property="og:title"       content="<?php echo htmlentities($config->text_lot, ENT_COMPAT, 'UTF-8') ; ?>"> 
  <meta property="og:description" content="<?php echo htmlentities($config->text_lot_desc, ENT_COMPAT, 'UTF-8') ; ?>"> 
...
<script type="text/javascript">
  ...
  _gaq.push(['_trackPageview', '/virality/openGraph']);
</script>
<?php } ?>
<script type="text/javascript">
