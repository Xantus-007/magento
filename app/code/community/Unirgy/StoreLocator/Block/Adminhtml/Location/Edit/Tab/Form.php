...
class Unirgy_StoreLocator_Block_Adminhtml_Location_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
		...
		/**/
		    ...
		    $fieldset->addField('product_types', 'image', array(
            'name'      => 'product_types',
            'label'     => Mage::helper('ustorelocator')->__('Photo du répresentant'),
            'class'     => 'required-entry',
            'required'  => true,
        ));
        ...
        $fieldset->addField('address_display', 'textarea', array(
            ...
            'label'     => Mage::helper('ustorelocator')->__('L\'adresse'),
            'class'     => 'required-entry',
            'style'     => 'height:50px',
            'required'  => true,
        ...
        $fieldset->addField('phone', 'text', array(
            'name'      => 'phone',
            'label'     => Mage::helper('ustorelocator')->__('Telephone'),
        ));
        ...
        $fieldset = $form->addFieldset('geo_form', array(
            'legend'=>Mage::helper('ustorelocator')->__('Geolocalisation')
        ));

        $fieldset->addField('address', 'textarea', array(
            'name'      => 'address',
            'style'     => 'height:50px',
            'label'     => Mage::helper('ustorelocator')->__('address'),
