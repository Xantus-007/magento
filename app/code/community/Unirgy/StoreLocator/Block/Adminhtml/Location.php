...
class Unirgy_StoreLocator_Block_Adminhtml_Location extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('ustorelocator')->__('Gerer les coordonées des magasins');
        $this->_addButtonLabel = Mage::helper('ustorelocator')->__('Ajouter des coordonées de nouveau magasin');
        parent::__construct();
    }
}