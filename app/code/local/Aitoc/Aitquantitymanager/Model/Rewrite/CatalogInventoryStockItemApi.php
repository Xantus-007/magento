<?php
if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitquantitymanager')){ DIBIEhIjqBhreImD('e09458d4f4c3abbac3ff956e56582bd8');
/**
    ...
    public function update($productId, $data)
    {
        ...
        if (is_array($data) && !$defaultUpdate)
        {
            ...
            foreach ($data as $stock)
            {
                ...
                {
                    $stockItem = Mage::getModel('cataloginventory/stock_item')->loadByProduct($productId, $stock['website_id']);
                    if(!$stockItem->getId())
                    {
