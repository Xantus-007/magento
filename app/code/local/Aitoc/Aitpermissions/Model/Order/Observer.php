 ...
 * File path:   app/code/local/Aitoc/Aitpermissions/Model/Order/Observer.php
 * Copyright:   (c) 2013 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitpermissions')){ qorySkjDCDqhwwah('3c36c85264fb59c0284de644eface2b9'); ?><?php
class Aitoc_Aitpermissions_Model_Order_Observer extends Mage_Core_Model_Abstract
{
