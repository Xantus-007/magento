...
class Dbm_ExtendBetterBlog_Block_Adminhtml_Post_Attribute_Set_Main extends Mage_Adminhtml_Block_Template
{
    /**
     * Initialize template
     *
    ...
    {
        return $this->getUrl('*/extendBetterBlog_post_type/save', array('id' => $this->_getSetId()));
    }
    ...
    public function getGroupTreeJson()
    {
        ...
        foreach ($groups as $node) {
            ...
            $nodeChildren = Mage::getResourceModel('mageplaza_betterblog/post_attribute_collection')
    ...
    public function getAttributeTreeJson()
    {
        ...
        $attributes = Mage::getResourceModel('mageplaza_betterblog/post_attribute_collection')
