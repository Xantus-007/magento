...
require_once(Mage::getModuleDir('controllers','Unirgy_SimpleUp').DS.'Adminhtml'.DS.'ModuleController');

class Dbm_Utils_Adminhtml_ModuleController extends Unirgy_SimpleUp_Adminhtml_ModuleController
{
