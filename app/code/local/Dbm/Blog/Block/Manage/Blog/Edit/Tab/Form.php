...
class Dbm_Blog_Block_Manage_Blog_Edit_Tab_Form extends AW_Blog_Block_Manage_Blog_Edit_Tab_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            array(
                 ...
                 'values'             => array(
                     array(
                         'value' => 1,
                         'label' => Mage::helper('blog')->__('Activé'),
                     ),
                     array(
                         'value' => 2,
                         'label' => Mage::helper('blog')->__('Désactivé'),
                     ),
                     array(
                         'value' => 3,
                         'label' => Mage::helper('blog')->__('Caché'),
                     ),
                 ),
        ...
        $fieldset->addField('show_in_home', 'select', array(
        ...
        if (Mage::getSingleton('adminhtml/session')->getBlogData()) {
            ...
            $imageField = $form->getElement('post_image')->getValue();
            $form->getElement('post_image')->setValue('blog/' . $imageField);
