...
class Altiplano_Ngroups_Block_Adminhtml_Oldsubscriber_Gridreload extends Mage_Adminhtml_Block_Widget_Grid {
    /**
     * Constructor
     *
    ...
    protected function _prepareCollection() {
        ...
        if ($this->getRequest()->getParam('id') > 0) {
            ...
            if (isset($info['items'][0]['customers'])) {
                ...
                $customers = preg_split('[,]', $info['items'][0]['customers']);

                $collection = Mage::getModel('newsletter/mysql4_subscriber_collection')->addFieldToFilter('subscriber_id', $customers);
