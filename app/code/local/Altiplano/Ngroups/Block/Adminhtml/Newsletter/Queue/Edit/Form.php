...
class Altiplano_Ngroups_Block_Adminhtml_Newsletter_Queue_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('user_group', 'select', array(
          'label'     => Mage::helper('ngroups')->__('Newsletter for Subscribers Group'),
          'name'      => 'user_group',
          'values'    => $groupsOptionArray,
          'value'     => $queue->getTemplate()->getUserGroup(),
       ));
