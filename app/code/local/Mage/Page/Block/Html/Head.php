...
class Mage_Page_Block_Html_Head extends Mage_Core_Block_Template
{
    ...
    public function getCssJsHtml()
    {
        ...
        foreach ($lines as $if => $items) {
            ...
            $cacheToken = Mage::helper('dbm_utils')->getHeadLinkToken();
            // static and skin css
            $html .= $this->_prepareStaticAndSkinElements('<link rel="stylesheet" type="text/css" href="%s?'.$cacheToken.'"%s />'."\n",
            ...
            $html .= $this->_prepareStaticAndSkinElements('<script type="text/javascript" src="%s?'.$cacheToken.'"%s></script>' . "\n",
