...
class Wizkunde_ConfigurableBundle_Model_Sales_Order_Pdf_Items_Invoice extends Mage_Bundle_Model_Sales_Order_Pdf_Items_Invoice
{
    /**
     * Draw item line
     *
    ...
    public function draw()
    {
        ...
        foreach ($items as $_item) {
            $totalPrice_tax = $_item->getRowTotalInclTax();
            $orderItemTaxPercent = $_item->getOrderItem()->getTaxPercent();
